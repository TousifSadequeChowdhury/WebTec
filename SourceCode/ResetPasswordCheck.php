...
$currentpassword=getdata(@$_POST['currentpassword']);
    ...
    {
        header("Location:../SourceCode/Reset.php?validemail=$validemail&validphonenumber=$validphonenumber&currentpassword=$currentpassword&newpassword=$newpassword&confirmpassword=$confirmpassword");
    }
