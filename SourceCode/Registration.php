...
<body>
<body >
<h1 style="text-align: center;background-color: #2a5e85;color:#ffffff">Registration Form</h1>
<h6 style="text-align: center;background-color: #CBF83E;color:#CBF83E">.</h6>
 ...
 <fieldset style="width: 30%; margin-left: 34%">
     ...
     <form action="../SourceCode/RegistrationCheck.php" method="POST" novalidate> 
        <div class="username">
